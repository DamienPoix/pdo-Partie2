...
<html lang="fr" dir="ltr">
    ...
    <body id="addPatientView">
        ...
        <?php if (isset($_POST['submit']) && (count($formError) === 0)) { ?>
            ...
            <p id="ok"><a href="addPatient.php" title="lien vers l'ajout de patient" alt="ajout de patient"><button type="button" class="btn btn-dark">AJOUTER UN NOUVEAU PATIENT</button></a></p>
        <?php } else { ?>
